...
public class IsohedralTilingSolver2Data {
	...
	public void printDebugInfo() {
		...
		System.out.println("Right neighbors:     " + FormatUtils.stringify(edgeRightNeighbors));
		System.out.println("Left neighbors:      " + FormatUtils.stringify(edgeLeftNeighbors));
		System.out.println("Left vertex weights: " + FormatUtils.stringify(leftVertexWeights));
		System.out.println("Mirrors:             " + FormatUtils.stringify(edgeMirrors));
		System.out.println("Edge types:          " + FormatUtils.stringify(edgeTypes));
		System.out.println("Match types:         " + FormatUtils.stringify(matchTypes));
